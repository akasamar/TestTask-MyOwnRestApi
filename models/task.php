...
//короче обязательное условие sort_option и order_by нужно использовать вместе!! либо не использовать вообще


//вынести айди чтоб массивы инфа была внутри
//сделать проверку на ввод данных
class Task
{
